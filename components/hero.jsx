  ...
  return (
    <section className="relative overflow-hidden">
      <div className="mx-auto max-w-6xl">
        <div className="relative min-h-[400px] sm:min-h-[600px] lg:min-h-[700px] xl:min-h-[800px]">
          <div className="absolute left-[-16%] top-[-30%] md:top-[-50%] flex h-[500px] w-[500px] flex-col items-center justify-center rounded-full bg-white text-center sm:h-[700px] sm:w-[700px] md:h-[800px] md:w-[800px] lg:h-[1000px] lg:w-[1000px] xl:h-[1100px] xl:w-[1100px]">
