...
export function Partners() {
  return (
    <section id="samenwerken" className="bg-secondary py-20 md:py-28">
        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Samen zorgen we dat technologie bijdraagt aan een eerlijke, duurzame en inclusieve
              stad. Tech for Impact werkt samen met partijen die dezelfde visie delen.
            </p>
          </div>
